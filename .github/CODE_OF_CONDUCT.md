...
This Code of Conduct applies within all project spaces — including `apps/*`,
`packages/*`, GitHub issues, pull requests, and any other project-related
communication.

## Enforcement

Instances of abusive, harassing, or otherwise unacceptable behavior may be
reported to the project maintainer at **slava.melanko@gmail.com**. All
...
**1. Correction** — Private written warning with clarity on the violation. A
public apology may be requested.

**2. Warning** — A warning with consequences for continued behavior. No
interaction with involved parties for a specified period.

**3. Temporary Ban** — Temporary ban from any interaction or public
communication with the community.

**4. Permanent Ban** — Permanent ban from any public interaction within the
community.
